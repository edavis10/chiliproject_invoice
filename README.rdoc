...
1. Follow the ChiliProject plugin installation steps at: http://www.redmine.org/wiki/redmine/Plugins 
...
3. Install the Invoice plugin to 'vendor/plugin/chiliproject_invoice'
4. Run the plugin migrations +rake db:migrate_plugins+
5. Restart your ChiliProject web servers (e.g. mongrel, thin, mod_rails)
